<template>
  <section
    ...
    class="absolute left-1/2 -translate-x-1/2 mt-3 bottom-5 text-white opacity-80 cursor-pointer z-20 hidden group-hover:flex"
  >
...
const { changeCameraRound } = useDevicesStore()
